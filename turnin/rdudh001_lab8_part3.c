...
enum States1 {smstart1, wait1, play, wait2} state1;
//enum States0 {smstart0, wait, inc, inc_wait, dec, dec_wait} state0;
//unsigned short sound;

void Tick1() {
	unsigned char check = ~PINA & 0x01;//FIXME negation
	double freqs[40] = {392, 0, 0, 523.25, 0, 392.00,  0, 392, 0, 392, 0, 0, 0, 523.35, 0, 392, 0, 392, 0, 392, 0, 0, 0, 532.25, 0, 392, 0, 392, 0, 392, 392, 392, 392, 392, 392, 392, 392, 392, 392, 392};
